...
public class Menghitung {
    //buat batas maks panjang baris agar rapi
    ...
    public void gcd(int i, int j){
        ...
        while (j != 0) {
            //nilainya j disimpan pada variable temp
            int temp = j;
            //menghitung sisa bagi i dan j yang disimpan pada nilai j
            j = i % j;
            //nilai i diganti dengan nilai j yang disimpan pada temp
            i = temp;
        }
        fpb = Math.abs(i); //i merupakan fpbnya dan dikasih math.abs agar nilai selalu positif
    }
